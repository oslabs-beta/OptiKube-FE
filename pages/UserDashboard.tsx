...
const UserDashboard = () => {
  ...
  const chartItems = [
    {
      ...
      xName: '', // Any additional props if needed
      yName: '',  // Any additional props if needed
    },
    {
      type: 'area',
      data: serverDataWeek, // Data for AreaChart
      xName: 'Time', // Example prop
      yName: 'Total Cost',  // Example prop
    },
  ];
  ...
  return (
    <div className="relative h-[50rem]"> {/* Set the relative positioning and height */}
      ...
      <GridBackgroundDemo /> {/* Background component for additional styling/effects */}
  
      {/* Absolute positioning to center the InfiniteMovingCards component within its parent */}
      <div className="absolute top-[100px] inset-0 flex items-center justify-center">
        <InfiniteMovingCards items={chartItems} direction="left" speed="normal" pauseOnHover={true} />
      </div>
